...
\author[a,1,2]{Frédérick St-Pierre}
...
Résumé: \textbar{} Please provide an abstract of no more than 250 words
in a single paragraph. Abstracts should explain to the general reader
the major contributions of the article. References in the abstract must
be cited in full within the abstract itself and cited in the text.

Significance: \textbar{} Ce travail a été réalisé dans le cadre du cours
BOT500 par des étudiants au BAC en écologie.

keywords: - Diversité - Paruline - Québec

\hypertarget{must-be-one-of-pnasresearcharticle-usual-two-column-layout-pnasmathematics-one-column-layout-or-pnasinvited-invited-submissions-only}{%
\subsection{must be one of: pnasresearcharticle (usual two-column
layout), pnasmathematics (one column layout), or pnasinvited (invited
submissions
only)}\label{must-be-one-of-pnasresearcharticle-usual-two-column-layout-pnasmathematics-one-column-layout-or-pnasinvited-invited-submissions-only}}

pnas\_type: pnasresearcharticle

bibliography: pnas-sample.bib csl: pnas.csl

\hypertarget{change-to-true-to-add-optional-line-numbering}{%
\subsection{change to true to add optional line
numbering}\label{change-to-true-to-add-optional-line-numbering}}

lineno: false

\hypertarget{output-rticlespnas_article}{%
\subsection{output:
rticles::pnas\_article}\label{output-rticlespnas_article}}
>>>>>>> 195fcdbaa1b4e4e6a204e36254577f41e7ece0c4
