...
- La @ref(fig:Fig1) présente le nombre d’espèces présentes en fonction de la latitude 
...
```
## Figure 1: Nombre d'espèces présentes en fonction de la latitude{#Fig1}

- La Figure 2 (@ref(fig:Fig2)) présente l’abondance des observations de parulines, elle aussi en
...
```
## Figure 2: Abondance de parulines en fonction de la latitude{#Fig2}

- La Figure 3 (@ref(fig: Fig3))présente le nombre d’espèces uniques observées dans tous les sites
...
```
## Figure 3: Nombre d'espèces en fonction de la latitude {#Fig3}
...
fiant à la figure 2 (@ref(fig:Fig2)), on observe que les parulines suivent une 
...
(@ref(fig:Fig1). Cette tendance d’abondance se maintenait pour l’entièreté des 
...
la migration des espèces davantage vers le nord (Gahbauer, et al., 2022). 
...
été observées à une même station d’échantillonnage (@ref(fig:Fig1)). À l’autre 
...
richesse spécifique. En comparant la courbe de la figure 1 (@ref(fig:Fig1)) et 
celle de la figure 2 (@ref(fig:Fig2)), il semble avoir une forte corrélation 
entre le nombre d’espèce et l’abondance. C’est deux courbes  
...
la figure 3 (@ref(fig:Fig3)), on peut observer une augmentation du nombre d’espèces 
