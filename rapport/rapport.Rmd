...
```
## Figure 1: Nombre d'espèce en fonction de la latitude au Québec
```{r Fig1, echo=FALSE}
bd_tsn <- tar_read(bd_tsn)
creation_Fig1(bd_tsn)
```

## Figure 2: Abondance de paruline en fonction de la latitude au Québec
```{r Fig2, echo=FALSE}
bd_tsn <- tar_read(bd_tsn)
...
##Figure 4: Nombre d'espèce uniques de tous les sites par année
```{r Fig4, echo=FALSE}
bd_tsn <- tar_read(bd_tsn)
